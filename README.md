...
- [x] **牌型比大小**：豹子 > 同花顺 > 同花 > 顺子 > 对子 > 散牌；非同花 235 专克豹子
- [x] **记账系统**：庄家 vs 各玩家逐人结算，累计得分持久化
- [x] **过庄机制**：全开全胜 + 豹子/同花顺 → 自动过庄；牌组不足 → 自动过庄 + 刷新
